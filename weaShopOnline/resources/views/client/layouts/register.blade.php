 			...
 			<div class="modal-body">
 				<form method="POST" action="{{ route('client.register') }}">
 					...
 					<div class="row">
 						...
 						<div class="col-md-6">
 							<div class="form-group">
 								<input id="full_name" type="text" placeholder="Full Name" class="form-control @error('full_name') is-invalid @enderror" name="full_name" value="{{ old('full_name') }}" required autocomplete="full_name" autofocus>
 							...
 							<div class="form-group">
 								<input id="phone_no" type="text" placeholder="Phone No" class="form-control @error('phone_no') is-invalid @enderror" name="phone_no" value="{{ old('phone_no') }}" required autocomplete="phone_no" autofocus>
